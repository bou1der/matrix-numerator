  ...
  return (
    <>
      <WelcomeBlock theme="MAIN" >
        <h1 className="text-secondary-foreground text-center max-w-[832px] font-medium">
          Раскройте тайны с <b className="italic text-2xl sm:text-5xl font-bold">«Ключом Души»</b> — уникальные расчеты для вашего пути
        </h1>
